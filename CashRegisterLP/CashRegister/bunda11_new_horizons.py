...
# changes stock in inventory
            ...
            include_0_TorF = False

            input_integer_return = input_integer(question_, include_0_TorF)
            ...
            change_hardrive_stock(item_id, item_info_address, str_change_stock)
...
# Does a full checkout, changes inventory according to the cart (and saves receipts and inventory to an online database)
            ...
            for item_id in current_cart:
                int_amount_bought = current_cart[item_id]
