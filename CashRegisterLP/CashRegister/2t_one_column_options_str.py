...
str_menu_options = str_one_column_menu_options(length, height - 2, ls_option_titles, column_options_start_pos)
str_menu_select_box = main_custimizable_empty_str_box(sel_len, sel_height, ls_top_right_bot_left_chars, upper_left_diag_column_options_start_pos)
