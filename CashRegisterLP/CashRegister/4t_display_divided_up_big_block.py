        ...
        def GUI_item_searcher_block_updater(start_option, box_info, options):
            ...
            for _ in range(2):
                while True:
                    ...
                    key_downTorF = event_.event_type == keyboard1.KEY_DOWN
                    ...
                    if ((event_.name == 'up') or (event_.name == 'down')) and key_downTorF:
                    ...
                    elif (event_.name == 'left') and key_downTorF:
                        return ('left', sel_option_before_change)
                    
                    elif (event_.name == 'right') and key_downTorF:
                        return ('right', sel_option_before_change)


                    elif (event_.name == 'enter') and key_downTorF: # we gotta create an iterable test solutio nfor this yeah that makes sens 
