import colorama1
from colorama1 import just_fix_windows_console, Fore, Back, Style
import os
...
ls_menu_box_row_column_chars = ['_', '|']
...
column_start_x = box_perimeter_x + 3
column_start_y = box_perimeter_y + 3

column_options_start_pos = pos(column_start_x, column_start_y)

sel_len = len(Main_menu_options[1]) + 2
sel_height = 3

str_menu_box = main_same_top_and_bot_empty_str_box(length, height, ls_menu_box_row_column_chars, box_permiter_top_left)
str_menu_options_plus_chars_between_titles = str_one_column_menu_options(length, height - 2, Main_menu_options, column_options_start_pos)

str_menu_options = str_menu_options_plus_chars_between_titles[0]
chars_between_titles = str_menu_options_plus_chars_between_titles[1]

_1st_column_option_coords = [box_perimeter_x + 3, box_perimeter_y + 3]
...
sel_option_y_offset = (column_start_y) + ((option_number - 1) * chars_between_titles)

# 5 plus chars bweteen titles 

sel_option_pos = pos(column_start_x, sel_option_y_offset)



# print(box_permiter_top_left + str_menu_box + column_options_start_pos + str_menu_options )#+ str_menu_select_box) # column-start pos might be reduncant

# input()
# print(str_menu_select_box)

FORES = [ Fore.BLACK, Fore.RED, Fore.GREEN, Fore.YELLOW, Fore.BLUE, Fore.MAGENTA, Fore.CYAN, Fore.WHITE ]
BACKS = [ Back.BLACK, Back.RED, Back.GREEN, Back.YELLOW, Back.BLUE, Back.MAGENTA, Back.CYAN, Back.WHITE ]
STYLES = [ Style.DIM, Style.NORMAL, Style.BRIGHT ]

print(box_permiter_top_left + str_menu_box + column_options_start_pos + str_menu_options)

title = Main_menu_options[1]

print(sel_option_pos + Fore.MAGENTA + title)
