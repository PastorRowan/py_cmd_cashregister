...
column_options_start_pos = pos(box_perimeter_x + 3, box_perimeter_y + 3)

upper_left_diag_column_options_start_pos = pos(box_perimeter_x + 2, box_perimeter_y + 1)
...
str_menu_options_plus_chars_between_titles = str_one_column_menu_options(length, height - 2, ls_option_titles, column_options_start_pos)
